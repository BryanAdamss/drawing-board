...
return!Object("z").propertyIsEnumerable(0)})?function(e){return"String"==classofRaw(e)?split.call(e,""):Object(e)}:Object,requireObjectCoercible=function(e){if(e==null)throw TypeError("Can't call method on "+e);return e},toIndexedObject=function(e){return indexedObject(requireObjectCoercible(e))},isObject=function(e){return"object"==typeof e?null!==e:"function"==typeof e},toPrimitive=function(e,t){if(!isObject(e))return e;var n,a;if(t&&"function"==typeof(n=e.toString)&&!isObject(a=n.call(e)))return a;if("function"==typeof(n=e.valueOf)&&!isObject(a=n.call(e)))return a;if(!t&&"function"==typeof(n=e.toString)&&!isObject(a=n.call(e)))return a;throw TypeError("Can't convert object to primitive value")},hasOwnProperty={}.hasOwnProperty,has=function(e,t){return hasOwnProperty.call(e,t)},document$1=global_1.document,EXISTS=isObject(document$1)&&isObject(document$1.createElement),documentCreateElement=function(e){return EXISTS?document$1.createElement(e):{}},ie8DomDefine=!descriptors&&!fails(function(){return 7!=Object.defineProperty(documentCreateElement("div"),"a",{get:function(){return 7}}).a}),nativeGetOwnPropertyDescriptor=Object.getOwnPropertyDescriptor,f$1=descriptors?nativeGetOwnPropertyDescriptor:function(e,t){if(e=toIndexedObject(e),t=toPrimitive(t,!0),ie8DomDefine)try{return nativeGetOwnPropertyDescriptor(e,t)}catch(e){/* empty */}return has(e,t)?createPropertyDescriptor(!objectPropertyIsEnumerable.f.call(e,t),e[t]):void 0},objectGetOwnPropertyDescriptor={f:f$1},anObject=function(e){if(!isObject(e))throw TypeError(e+" is not an object");return e},nativeDefineProperty=Object.defineProperty,f$2=descriptors?nativeDefineProperty:function(e,t,n){if(anObject(e),t=toPrimitive(t,!0),anObject(n),ie8DomDefine)try{return nativeDefineProperty(e,t,n)}catch(e){/* empty */}if("get"in n||"set"in n)throw TypeError("Accessors not supported");return"value"in n&&(e[t]=n.value),e},objectDefineProperty={f:f$2},hide=descriptors?function(e,t,n){return objectDefineProperty.f(e,t,createPropertyDescriptor(1,n))}:function(e,t,n){return e[t]=n,e},setGlobal=function(e,t){try{hide(global_1,e,t)}catch(n){global_1[e]=t}return t},isPure=!1,shared=createCommonjsModule(function(e){var t=global_1["__core-js_shared__"]||setGlobal("__core-js_shared__",{});(e.exports=function(e,n){return t[e]||(t[e]=n===void 0?{}:n)})("versions",[]).push({version:"3.2.1",mode:"global",copyright:"\xA9 2019 Denis Pushkarev (zloirock.ru)"})}),functionToString=shared("native-function-to-string",Function.toString),WeakMap=global_1.WeakMap,nativeWeakMap="function"==typeof WeakMap&&/native code/.test(functionToString.call(WeakMap)),id=0,postfix=Math.random(),uid=function(e){return"Symbol("+((e===void 0?"":e)+"")+")_"+(++id+postfix).toString(36)},keys=shared("keys"),sharedKey=function(e){return keys[e]||(keys[e]=uid(e))},hiddenKeys={},WeakMap$1=global_1.WeakMap,enforce=function(e){return has$1(e)?get(e):set(e,{})},getterFor=function(e){return function(t){var n;if(!isObject(t)||(n=get(t)).type!==e)throw TypeError("Incompatible receiver, "+e+" required");return n}};if(nativeWeakMap){var store=new WeakMap$1,wmget=store.get,wmhas=store.has,wmset=store.set;set=function(e,t){return wmset.call(store,e,t),t},get=function(e){return wmget.call(store,e)||{}},has$1=function(e){return wmhas.call(store,e)}}else{var STATE=sharedKey("state");hiddenKeys[STATE]=!0,set=function(e,t){return hide(e,STATE,t),t},get=function(e){return has(e,STATE)?e[STATE]:{}},has$1=function(e){return has(e,STATE)}}var internalState={set:set,get:get,has:has$1,enforce:enforce,getterFor:getterFor},redefine=createCommonjsModule(function(e){var t=internalState.get,n=internalState.enforce,a=(functionToString+"").split("toString");shared("inspectSource",function(e){return functionToString.call(e)}),(e.exports=function(e,t,o,r){var i=!!r&&!!r.unsafe,l=!!r&&!!r.enumerable,c=!!r&&!!r.noTargetGet;return("function"==typeof o&&("string"==typeof t&&!has(o,"name")&&hide(o,"name",t),n(o).source=a.join("string"==typeof t?t:"")),e===global_1)?void(l?e[t]=o:setGlobal(t,o)):void(i?!c&&e[t]&&(l=!0):delete e[t],l?e[t]=o:hide(e,t,o))})(Function.prototype,"toString",function(){return"function"==typeof this&&t(this).source||functionToString.call(this)})}),path=global_1,aFunction=function(e){return"function"==typeof e?e:void 0},getBuiltIn=function(e,t){return 2>arguments.length?aFunction(path[e])||aFunction(global_1[e]):path[e]&&path[e][t]||global_1[e]&&global_1[e][t]},ceil=Math.ceil,floor=Math.floor,toInteger=function(e){return isNaN(e=+e)?0:(0<e?floor:ceil)(e)},min=Math.min,toLength=function(e){return 0<e?min(toInteger(e),9007199254740991):0;// 2 ** 53 - 1 == 9007199254740991
},max=Math.max,min$1=Math.min,toAbsoluteIndex=function(e,t){var n=toInteger(e);return 0>n?max(n+t,0):min$1(n,t)},createMethod=function(e){return function(t,n,a){var o,r=toIndexedObject(t),i=toLength(r.length),l=toAbsoluteIndex(a,i);// Array#includes uses SameValueZero equality algorithm
...
indexOf:createMethod(!1)},indexOf=arrayIncludes.indexOf,objectKeysInternal=function(e,t){var n,a=toIndexedObject(e),o=0,r=[];for(n in a)!has(hiddenKeys,n)&&has(a,n)&&r.push(n);// Don't enum bug & hidden keys
for(;t.length>o;)has(a,n=t[o++])&&(~indexOf(r,n)||r.push(n));return r},enumBugKeys=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"],hiddenKeys$1=enumBugKeys.concat("length","prototype"),f$3=Object.getOwnPropertyNames||function(e){return objectKeysInternal(e,hiddenKeys$1)},objectGetOwnPropertyNames={f:f$3},f$4=Object.getOwnPropertySymbols,objectGetOwnPropertySymbols={f:f$4},ownKeys=getBuiltIn("Reflect","ownKeys")||function(e){var t=objectGetOwnPropertyNames.f(anObject(e)),n=objectGetOwnPropertySymbols.f;return n?t.concat(n(e)):t},copyConstructorProperties=function(e,t){for(var n,a=ownKeys(t),o=objectDefineProperty.f,r=objectGetOwnPropertyDescriptor.f,l=0;l<a.length;l++)n=a[l],has(e,n)||o(e,n,r(t,n))},replacement=/#|\.prototype\./,isForced=function(e,t){var n=data[normalize(e)];return!(n!=POLYFILL)||n!=NATIVE&&("function"==typeof t?fails(t):!!t)},normalize=isForced.normalize=function(e){return(e+"").replace(replacement,".").toLowerCase()},data=isForced.data={},NATIVE=isForced.NATIVE="N",POLYFILL=isForced.POLYFILL="P",isForced_1=isForced,getOwnPropertyDescriptor$1=objectGetOwnPropertyDescriptor.f,_export=function(e,t){var n,a,o,r,i,l,c=e.target,d=e.global,s=e.stat;if(a=d?global_1:s?global_1[c]||setGlobal(c,{}):(global_1[c]||{}).prototype,a)for(o in t){// contained in target
if(i=t[o],e.noTargetGet?(l=getOwnPropertyDescriptor$1(a,o),r=l&&l.value):r=a[o],n=isForced_1(d?o:c+(s?".":"#")+o,e.forced),!n&&void 0!==r){if(typeof i==typeof r)continue;copyConstructorProperties(i,r)}// add a flag to not completely full polyfills
(e.sham||r&&r.sham)&&hide(i,"sham",!0),redefine(a,o,i,e)}},isArray=Array.isArray||function(e){return"Array"==classofRaw(e)},toObject=function(e){return Object(requireObjectCoercible(e))},createProperty=function(e,t,n){var a=toPrimitive(t);a in e?objectDefineProperty.f(e,a,createPropertyDescriptor(0,n)):e[a]=n},nativeSymbol=!!Object.getOwnPropertySymbols&&!fails(function(){// Chrome 38 Symbol has incorrect toString conversion
...
var e,t,a,o,r,l=toObject(this),c=arraySpeciesCreate(l,0),d=0;for(e=-1,a=arguments.length;e<a;e++)if(r=-1===e?l:arguments[e],isConcatSpreadable(r)){if(o=toLength(r.length),d+o>MAX_SAFE_INTEGER)throw TypeError(MAXIMUM_ALLOWED_INDEX_EXCEEDED);for(t=0;t<o;t++,d++)t in r&&createProperty(c,d,r[t])}else{if(d>=MAX_SAFE_INTEGER)throw TypeError(MAXIMUM_ALLOWED_INDEX_EXCEEDED);createProperty(c,d++,r)}return c.length=d,c}});// `Array.prototype.fill` method implementation
// https://tc39.github.io/ecma262/#sec-array.prototype.fill
var arrayFill=function(e/* , start = 0, end = @length */){for(var t=toObject(this),n=toLength(t.length),a=arguments.length,o=toAbsoluteIndex(1<a?arguments[1]:void 0,n),r=2<a?arguments[2]:void 0,i=void 0===r?n:toAbsoluteIndex(r,n);i>o;)t[o++]=e;return t},objectKeys=Object.keys||function(e){return objectKeysInternal(e,enumBugKeys)},objectDefineProperties=descriptors?Object.defineProperties:function(e,t){anObject(e);for(var n,a=objectKeys(t),o=a.length,r=0;o>r;)objectDefineProperty.f(e,n=a[r++],t[n]);return e},html=getBuiltIn("document","documentElement"),IE_PROTO=sharedKey("IE_PROTO"),PROTOTYPE="prototype",Empty=function(){/* empty */},createDict=function(){// Thrash, waste and sodomy: IE GC bug
var e,t=documentCreateElement("iframe"),n=enumBugKeys.length,a="<",o="script",r=">";for(t.style.display="none",html.appendChild(t),t.src="java"+o+":"+"",e=t.contentWindow.document,e.open(),e.write(a+o+r+"document.F=Object"+a+"/"+o+r),e.close(),createDict=e.F;n--;)delete createDict[PROTOTYPE][enumBugKeys[n]];return createDict()},objectCreate=Object.create||function(e,t){var n;return null===e?n=createDict():(Empty[PROTOTYPE]=anObject(e),n=new Empty,Empty[PROTOTYPE]=null,n[IE_PROTO]=e),void 0===t?n:objectDefineProperties(n,t)};// `Object.keys` method
...
return e===e?nativeDateToString.call(this):INVALID_DATE});var defineProperty=objectDefineProperty.f,FunctionPrototype=Function.prototype,FunctionPrototypeToString=FunctionPrototype.toString,nameRE=/^\s*function ([^ (]*)/,NAME="name";descriptors&&!(NAME in FunctionPrototype)&&defineProperty(FunctionPrototype,NAME,{configurable:!0,get:function(){try{return FunctionPrototypeToString.call(this).match(nameRE)[1]}catch(e){return""}}});var TO_STRING_TAG=wellKnownSymbol("toStringTag"),CORRECT_ARGUMENTS="Arguments"==classofRaw(function(){return arguments}()),tryGet=function(e,t){try{return e[t]}catch(e){/* empty */}},classof=function(e){var t,n,a;return e===void 0?"Undefined":null===e?"Null"// @@toStringTag case
:"string"==typeof(n=tryGet(t=Object(e),TO_STRING_TAG))?n// builtinTag case
:CORRECT_ARGUMENTS?classofRaw(t)// ES3 arguments fallback
:"Object"==(a=classofRaw(t))&&"function"==typeof t.callee?"Arguments":a},TO_STRING_TAG$1=wellKnownSymbol("toStringTag"),test={};// ES3 wrong here
test[TO_STRING_TAG$1]="z";// `Object.prototype.toString` method implementation
// https://tc39.github.io/ecma262/#sec-object.prototype.tostring
var objectToString=function(){return"[object "+classof(this)+"]"},ObjectPrototype=Object.prototype;objectToString!==ObjectPrototype.toString&&redefine(ObjectPrototype,"toString",objectToString,{unsafe:!0});// a string of all valid unicode whitespaces
// eslint-disable-next-line max-len
var whitespaces="\t\n\x0B\f\r \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF",whitespace="[\t\n\x0B\f\r \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF]",ltrim=RegExp("^"+whitespace+whitespace+"*"),rtrim=RegExp(whitespace+whitespace+"*$"),createMethod$2=function(e){return function(t){var n=requireObjectCoercible(t)+"";return 1&e&&(n=n.replace(ltrim,"")),2&e&&(n=n.replace(rtrim,"")),n}},stringTrim={// `String.prototype.{ trimLeft, trimStart }` methods
...
trim:createMethod$2(3)},trim=stringTrim.trim,nativeParseFloat=global_1.parseFloat,FORCED$1=1/nativeParseFloat("\t\n\x0B\f\r \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF-0")!=-Infinity,_parseFloat=FORCED$1?function(e){var t=trim(e+""),n=nativeParseFloat(t);return 0===n&&"-"==t.charAt(0)?-0:n}:nativeParseFloat;_export({global:!0,forced:parseFloat!=_parseFloat},{parseFloat:_parseFloat});var nativePromiseConstructor=global_1.Promise,redefineAll=function(e,t,n){for(var a in t)redefine(e,a,t[a],n);return e},defineProperty$1=objectDefineProperty.f,TO_STRING_TAG$2=wellKnownSymbol("toStringTag"),setToStringTag=function(e,t,n){e&&!has(e=n?e:e.prototype,TO_STRING_TAG$2)&&defineProperty$1(e,TO_STRING_TAG$2,{configurable:!0,value:t})},SPECIES$2=wellKnownSymbol("species"),setSpecies=function(e){var t=getBuiltIn(e),n=objectDefineProperty.f;descriptors&&t&&!t[SPECIES$2]&&n(t,SPECIES$2,{configurable:!0,get:function(){return this}})},anInstance=function(e,t,n){if(!(e instanceof t))throw TypeError("Incorrect "+(n?n+" ":"")+"invocation");return e},iterators={},ITERATOR=wellKnownSymbol("iterator"),ArrayPrototype$1=Array.prototype,isArrayIteratorMethod=function(e){return e!==void 0&&(iterators.Array===e||ArrayPrototype$1[ITERATOR]===e)},ITERATOR$1=wellKnownSymbol("iterator"),getIteratorMethod=function(e){if(e!=null)return e[ITERATOR$1]||e["@@iterator"]||iterators[classof(e)]},callWithSafeIterationClosing=function(e,t,n,a){try{return a?t(anObject(n)[0],n[1]):t(n);// 7.4.6 IteratorClose(iterator, completion)
}catch(t){var o=e["return"];throw void 0!==o&&anObject(o.call(e)),t}},iterate_1=createCommonjsModule(function(e){var t=function(e,t){this.stopped=e,this.result=t},n=e.exports=function(e,n,a,o,r){var i,l,c,d,s,g,u=bindContext(n,a,o?2:1);if(r)i=e;else{if(l=getIteratorMethod(e),"function"!=typeof l)throw TypeError("Target is not iterable");// optimisation for array iterators
if(isArrayIteratorMethod(l)){for(c=0,d=toLength(e.length);d>c;c++)if(s=o?u(anObject(g=e[c])[0],g[1]):u(e[c]),s&&s instanceof t)return s;return new t(!1)}i=l.call(e)}for(;!(g=i.next()).done;)if(s=callWithSafeIterationClosing(i,u,g.value,o),s&&s instanceof t)return s;return new t(!1)};n.stop=function(e){return new t(!0,e)}}),ITERATOR$2=wellKnownSymbol("iterator"),SAFE_CLOSING=!1;try{var called=0,iteratorWithReturn={next:function(){return{done:!!called++}},return:function(){SAFE_CLOSING=!0}};// eslint-disable-next-line no-throw-literal
iteratorWithReturn[ITERATOR$2]=function(){return this},Array.from(iteratorWithReturn,function(){throw 2})}catch(e){/* empty */}var defer,channel,port,checkCorrectnessOfIteration=function(e,t){if(!t&&!SAFE_CLOSING)return!1;var n=!1;try{var a={};a[ITERATOR$2]=function(){return{next:function(){return{done:n=!0}}}},e(a)}catch(e){/* empty */}return n},SPECIES$3=wellKnownSymbol("species"),speciesConstructor=function(e,t){var n,a=anObject(e).constructor;return a===void 0||(n=anObject(a)[SPECIES$3])==null?t:aFunction$1(n)},location=global_1.location,set$1=global_1.setImmediate,clear=global_1.clearImmediate,process=global_1.process,MessageChannel=global_1.MessageChannel,Dispatch=global_1.Dispatch,counter=0,queue={},ONREADYSTATECHANGE="onreadystatechange",run=function(e){// eslint-disable-next-line no-prototype-builtins
...
&&0!==v8.indexOf("6.6")&&-1===userAgent.indexOf("Chrome/66"))}),INCORRECT_ITERATION=FORCED$2||!checkCorrectnessOfIteration(function(e){PromiseConstructor.all(e)["catch"](function(){/* empty */})}),isThenable=function(e){var t;return!!(isObject(e)&&"function"==typeof(t=e.then))&&t},notify$1=function(e,t,n){if(!t.notified){t.notified=!0;var a=t.reactions;microtask(function(){// variable length - can't use forEach
for(var o=t.value,r=t.state==FULFILLED,i=0;a.length>i;){var l,c,d,s=a[i++],g=r?s.ok:s.fail,u=s.resolve,p=s.reject,h=s.domain;try{g?(!r&&(t.rejection===UNHANDLED&&onHandleUnhandled(e,t),t.rejection=HANDLED),!0===g?l=o:(h&&h.enter(),l=g(o),h&&(h.exit(),d=!0)),l===s.promise?p(TypeError$1("Promise-chain cycle")):(c=isThenable(l))?c.call(l,u,p):u(l)):p(o)}catch(e){h&&!d&&h.exit(),p(e)}}t.reactions=[],t.notified=!1,n&&!t.rejection&&onUnhandled(e,t)})}},dispatchEvent=function(e,t,n){var a,o;DISPATCH_EVENT?(a=document$2.createEvent("Event"),a.promise=t,a.reason=n,a.initEvent(e,!1,!0),global_1.dispatchEvent(a)):a={promise:t,reason:n},(o=global_1["on"+e])?o(a):e===UNHANDLED_REJECTION&&hostReportErrors("Unhandled promise rejection",n)},onUnhandled=function(e,t){task$1.call(global_1,function(){var n,a=t.value,o=isUnhandled(t);if(o&&(n=perform(function(){IS_NODE$1?process$2.emit("unhandledRejection",a,e):dispatchEvent(UNHANDLED_REJECTION,e,a)}),t.rejection=IS_NODE$1||isUnhandled(t)?UNHANDLED:HANDLED,n.error))throw n.value})},isUnhandled=function(e){return e.rejection!==HANDLED&&!e.parent},onHandleUnhandled=function(e,t){task$1.call(global_1,function(){IS_NODE$1?process$2.emit("rejectionHandled",e):dispatchEvent(REJECTION_HANDLED,e,t.value)})},bind=function(e,t,n,a){return function(o){e(t,n,o,a)}},internalReject=function(e,t,n,a){t.done||(t.done=!0,a&&(t=a),t.value=n,t.state=REJECTED,notify$1(e,t,!0))},internalResolve=function(e,t,n,a){if(!t.done){t.done=!0,a&&(t=a);try{if(e===n)throw TypeError$1("Promise can't be resolved itself");var o=isThenable(n);o?microtask(function(){var a={done:!1};try{o.call(n,bind(internalResolve,e,a,t),bind(internalReject,e,a,t))}catch(n){internalReject(e,a,n,t)}}):(t.value=n,t.state=FULFILLED,notify$1(e,t,!1))}catch(n){internalReject(e,{done:!1},n,t)}}};FORCED$2&&(PromiseConstructor=function(e){anInstance(this,PromiseConstructor,PROMISE),aFunction$1(e),Internal.call(this);var t=getInternalState(this);try{e(bind(internalResolve,this,t),bind(internalReject,this,t))}catch(e){internalReject(this,t,e)}},Internal=function(){setInternalState(this,{type:PROMISE,done:!1,notified:!1,parent:!1,reactions:[],rejection:!1,state:PENDING,value:void 0})},Internal.prototype=redefineAll(PromiseConstructor.prototype,{// `Promise.prototype.then` method
// https://tc39.github.io/ecma262/#sec-promise.prototype.then
then:function(e,t){var n=getInternalPromiseState(this),a=newPromiseCapability$1(speciesConstructor(this,PromiseConstructor));return a.ok="function"!=typeof e||e,a.fail="function"==typeof t&&t,a.domain=IS_NODE$1?process$2.domain:void 0,n.parent=!0,n.reactions.push(a),n.state!=PENDING&&notify$1(this,n,!1),a.promise},// `Promise.prototype.catch` method
...
fetch:function(){return promiseResolve(PromiseConstructor,$fetch.apply(global_1,arguments))}}))),_export({global:!0,wrap:!0,forced:FORCED$2},{Promise:PromiseConstructor}),setToStringTag(PromiseConstructor,PROMISE,!1),setSpecies(PROMISE),PromiseWrapper=path[PROMISE],_export({target:PROMISE,stat:!0,forced:FORCED$2},{// `Promise.reject` method
// https://tc39.github.io/ecma262/#sec-promise.reject
reject:function(e){var t=newPromiseCapability$1(this);return t.reject.call(void 0,e),t.promise}}),_export({target:PROMISE,stat:!0,forced:FORCED$2},{// `Promise.resolve` method
...
all:function(e){var t=this,n=newPromiseCapability$1(t),a=n.resolve,o=n.reject,r=perform(function(){var n=aFunction$1(t.resolve),r=[],i=0,l=1;iterate_1(e,function(e){var c=i++,d=!1;r.push(void 0),l++,n.call(t,e).then(function(e){d||(d=!0,r[c]=e,--l||a(r))},o)}),--l||a(r)});return r.error&&o(r.value),n.promise},// `Promise.race` method
// https://tc39.github.io/ecma262/#sec-promise.race
race:function(e){var t=this,n=newPromiseCapability$1(t),a=n.reject,o=perform(function(){var o=aFunction$1(t.resolve);iterate_1(e,function(e){o.call(t,e).then(n.resolve,a)})});return o.error&&a(o.value),n.promise}});var MATCH=wellKnownSymbol("match"),isRegexp=function(e){var t;return isObject(e)&&((t=e[MATCH])===void 0?"RegExp"==classofRaw(e):!!t)},notARegexp=function(e){if(isRegexp(e))throw TypeError("The method doesn't accept regular expressions");return e},MATCH$1=wellKnownSymbol("match"),correctIsRegexpLogic=function(e){var t=/./;try{"/./"[e](t)}catch(n){try{return t[MATCH$1]=!1,"/./"[e](t)}catch(e){/* empty */}}return!1};// `IsRegExp` abstract operation
...
// 默认宽度
// 默认高度
function e(t,n){_classCallCheck(this,e),this._init(t,n),this.manualMount||this.mount()}/**
   * 初始化
   * @param {HTMLElement|String} container 容器
   * @param {Object} options 选项
   */return _createClass(e,[{key:"_init",value:function(t,n){var a=this;if(!t)throw new Error("el\u4E3A\u5FC5\u586B\u9879");this.container="string"==typeof t?document.querySelector(t):t,this._defaultOptions={size:[],// canvas尺寸
className:"",// 自定义样式类
manualMount:!1,// 手动挂载
...
minScale:1,// 最小缩放比例
maxScale:3// 最大缩放比例
},this.options=_objectSpread2({},this._defaultOptions,{},n);var o=this.options,r=o.size,i=o.className,l=o.manualMount,c=o.maxRevokeSteps,d=o.interactiveMode,s=o.penColor,g=o.penWidth,u=o.bgImgURL,p=o.bgImgRotate,h=o.bgColor,m=o.onRevokeStackChange,v=o.onPaintEnd,f=o.penMode,y=o.minScale,_=o.maxScale,P=_slicedToArray(r,2),E=P[0],k=P[1];// 尺寸未传，则使用容器的尺寸
this.setSize([null==E?e.DEFAULT_WIDTH:E,null==k?e.DEFAULT_HEIGHT:k]),this.manualMount=l,this.revokeStack=[],this.MAX_REVOKE_STEPS=this._getLawfulMaxRevokeSteps(c),this.isPainting=!1,this.lastPaintPoint=null,this.isDraging=!1,this.lastDragPoint=null,this.dragTransformX=0,this.dragTransformY=0,this.penMode=e.PEN_MODE_ENUM.includes(f)?f:"empty",this.interactiveMode=e.INTERACTIVE_MODE_ENUM.includes(d)?d:"mouse",this.eventList=this._getEventList(),this.setPenStyle({color:s,width:g}),this.bgImgURL=u,this.bgColor=h,this.bgImgRotate=this._getLawfulRotateAngle(p),this.className=i,u?this._getImageFromURL(u).then(function(e){a._bgImgObject=e,a.originalSize=[e.width,e.height],a._drawBg.apply(a,[e].concat(_toConsumableArray(a.originalSize)))}).catch(function(e){console.log(e),a._bgImgObject=null}):this._bgImgObject=null,this.onRevokeStackChange=m,this.onPaintEnd=v,this.paintCount=0,this.minScale=y,this.maxScale=_,this._initScale()}/**
     * 获取事件映射列表
...
"paint"===this.penMode&&this._handlePaintEnd(t),"drag"===this.penMode&&this._handleDragEnd(t),this._cleanCurInteractiveModeEvents({action:"move"}),this._cleanCurInteractiveModeEvents({action:"end"}),this._cleanCurInteractiveModeEvents({action:"leave"}))}/**
     ...
     * @returns void
     */},{key:"_drawCircle",value:function(e,n){var a=2<arguments.length&&void 0!==arguments[2]?arguments[2]:3,o=3<arguments.length&&void 0!==arguments[3]?arguments[3]:"red";this.ctx&&(this.ctx.save(),this.ctx.fillStyle=o,this.ctx.beginPath(),this.ctx.arc(e,n,a,0,360*(t/180),!1),this.ctx.fill(),this.ctx.restore())}/**
     * 绘制移动时的直线
...
this.revokeStack.length>=this.MAX_REVOKE_STEPS&&this.revokeStack.shift(),this.revokeStack.push({type:e,paintCount:t,imageData:n}),this.onRevokeStackChange&&"function"==typeof this.onRevokeStackChange&&this.onRevokeStackChange(this.revokeStack),console.log("_saveImageData onRevokeStackChange",this.revokeStack))}/**
     ...
     * @returns void
     */},{key:"_setDOMSize",value:function(e){var t=_slicedToArray(e,2),n=t[0],a=t[1];null!=n&&this.el&&(this.el.width=n),null!=a&&this.el&&(this.el.height=a)}/**
     * 获取绘图上下文
     ...
     * @param {Number} h 高
     * @returns void
     */},{key:"_drawBg",value:function(e,n,a){if(e&&this.ctx&&this.ctx.drawImage&&n&&a&&!(0>=n)&&!(0>=a)){var o=0,r=n,i=a,l=0===this.bgImgRotate||180===this.bgImgRotate?-this.width/2:-this.height/2,c=0===this.bgImgRotate||180===this.bgImgRotate?-this.height/2:-this.width/2,d=0===this.bgImgRotate||180===this.bgImgRotate?this.width:this.height,s=0===this.bgImgRotate||180===this.bgImgRotate?this.height:this.width;this.ctx.save(),this.ctx.translate(this.width/2,this.height/2),this.ctx.rotate(t/180*this.bgImgRotate),console.log("\u65CB\u8F6C\u53C2\u6570:",0,o,r,i,l,c,d,s,this.bgImgRotate),this.ctx.drawImage(e,0,o,r,i,l,c,d,s),this.ctx.restore()}}/**
     * 获取合法角度值(逆时针旋转角度记录为正值，-90度 记录为270；450记录为90,10度记录为0,55度记录为90)
     * @param {Number} angle 角度
     * @returns 合法角度值
     */},{key:"_getLawfulRotateAngle",value:function(e){var t=Math.abs,n=Math.floor,a=Math.ceil;if(!("number"!=typeof e||isNaN(e))){var o=e%360,r=0>o?o+360:o,i=45<=r%90?90*a(r/90)%360:90*n(r/90)%360;// 可能存在-0
return t(i)}}/**
     * 初始化缩放
...
this._saveImageData("clear",this.paintCount,this.ctx.getImageData(0,0,this.width,this.height)),this.ctx.clearRect(0,0,this.width,this.height),this.paintCount=0,this._bgImgObject&&this._drawBg.apply(this,[this._bgImgObject].concat(_toConsumableArray(this.originalSize))),console.log("clear paintCount",this.paintCount))}/**
     ...
     * @param {Number} height 高
     * @returns void
     */},{key:"setSize",value:function(e){var t=_slicedToArray(e,2),n=t[0],a=t[1];n&&(this.width=n),a&&(this.height=a),this._setDOMSize([n,a])}/**
     * 重新初始化
     * @param {Object} options 选项
     * @returns void
...
"string"==typeof e&&/^(http[s]?)|(data:image)/.test(e)?this._getImageFromURL(e).then(function(e){a._bgImgObject=e,a.originalSize=[t||e.width,n||e.height],a._drawBg.apply(a,[e].concat(_toConsumableArray(a.originalSize)))}).catch(function(e){console.log(e),a._bgImgObject=null}):(e!==this._bgImgObject&&(this._bgImgObject=e),this.originalSize=[t||this.width,n||this.height],this._drawBg.apply(this,[e].concat(_toConsumableArray(this.originalSize))))}/**
     * 获取dataURL
